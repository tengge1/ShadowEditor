...
class HelperPanel extends React.Component {
  ...
  render() {
    ...
    return (
      <Form className={'HelperPanel'}>
        {/* <FormControl>
          <Label>{_t('Grid')}</Label>
          <CheckBox name={'showGrid'} checked={showGrid} onChange={this.handleChange} />
        </FormControl>
        <FormControl>
          <Label>{_t('Camera')}</Label>
          <CheckBox name={'showCamera'} checked={showCamera} onChange={this.handleChange} />
        </FormControl>
        <FormControl>
          <Label>{_t('Point Light')}</Label>
          <CheckBox name={'showPointLight'} checked={showPointLight} onChange={this.handleChange} />
        </FormControl>
        <FormControl>
          <Label>{_t('Directional Light')}</Label>
          <CheckBox name={'showDirectionalLight'} checked={showDirectionalLight} onChange={this.handleChange} />
        </FormControl>
        <FormControl>
          <Label>{_t('Spot Light')}</Label>
          <CheckBox name={'showSpotLight'} checked={showSpotLight} onChange={this.handleChange} />
        </FormControl>
        <FormControl>
          <Label>{_t('Hemisphere Light')}</Label>
          <CheckBox name={'showHemisphereLight'} checked={showHemisphereLight} onChange={this.handleChange} />
        </FormControl>
        <FormControl>
          <Label>{_t('Rect Area Light')}</Label>
          <CheckBox name={'showRectAreaLight'} checked={showRectAreaLight} onChange={this.handleChange} />
        </FormControl>
        <FormControl>
          <Label>{_t('Skeleton')}</Label>
          <CheckBox name={'showSkeleton'} checked={showSkeleton} onChange={this.handleChange} />
        </FormControl> */}
      </Form>
    );
  }
  ...
  handleChange(value, name) {
    ...
    const { showGrid, showCamera, showPointLight, showDirectionalLight, showSpotLight, showHemisphereLight, showRectAreaLight, showSkeleton } = Object.assign({}, this.state, {
      [name]: value,
    });
