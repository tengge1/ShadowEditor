...
class HelpMenu extends React.Component {
  ...
  render() {
    return (
      <MenuItem title={_t('Help')}>
        <MenuItem title={_t('Renderer Attributes')} onClick={this.handleRendererAttributes} />
        <MenuItem title={_t('Three.js Information')} onClick={this.handleThreeJsInformation} />
        <MenuItem title={_t('WebGL Extensions')} onClick={this.handleExtension} />
        <MenuItemSeparator />
        <MenuItem title={_t('Download Mesh')}>
          <MenuItem title={_t('Sketchfab')} onClick={this.handleVisitSketchfab} />
          <MenuItem title={_t('3dpunk')} onClick={this.handleVisit3dpunk} />
        </MenuItem>
        <MenuItemSeparator />
        <MenuItem title={_t('Source')}>
          <MenuItem title={_t('GitHub')} onClick={this.handleGitHubSource} />
          <MenuItem title={_t('Gitee')} onClick={this.handleGiteeSource} />
        </MenuItem>
        <MenuItem title={_t('Documents')} onClick={this.handleDocument} />
        <MenuItem title={_t('Examples')}>
          <MenuItem title={_t('GitHub')} onClick={this.handleGitHubExamples} />
          <MenuItem title={_t('Gitee')} onClick={this.handleGiteeExamples} />
        </MenuItem>
        <MenuItem title={_t('About')} onClick={this.handleAbout} />
      </MenuItem>
    );
  }
    ...
    global.app.alert({
      ...
      content: (
        <>
          ...
          <br />
          {_t('Source')}1:{' '}
          <a href="https://github.com/tengge1/ShadowEditor" target="_blank" rel="noopener noreferrer">
            https://github.com/tengge1/ShadowEditor
          </a>
          <br />
          {_t('Source')}2:{' '}
          <a href="https://gitee.com/tengge1/ShadowEditor" target="_blank" rel="noopener noreferrer">
