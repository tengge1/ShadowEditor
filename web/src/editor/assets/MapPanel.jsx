...
class MapPanel extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={classNames('MapPanel', className)} style={style}>
        <div className="toolbar">
          <IconMenuButton className={'add'} icon={'add'} show={!enableAuthority || authorities.includes('ADD_MAP')}>
            <ContextMenu>
              <MenuItem title={_t('Upload Image')} onClick={this.handleAddImage} />
              <MenuItem title={_t('Upload Sky Box')} onClick={this.handleAddSkyBox} />
              <MenuItem title={_t('Upload Sky Ball')} onClick={this.handleAddSkyBall} />
              <MenuItem title={_t('Upload Video')} onClick={this.handleAddVideo} />
            </ContextMenu>
          </IconMenuButton>
          <SearchField className={'search'} data={categoryData} placeholder={_t('Search Content')} showFilterButton onInput={this.handleSearch.bind(this)} />
        </div>
        <ImageList data={imageListData} showEditButton={!enableAuthority || authorities.includes('EDIT_MAP')} showDeleteButton={!enableAuthority || authorities.includes('DELETE_MAP')} onClick={this.handleClick} onEdit={this.handleEdit} onDelete={this.handleDelete} />
      </div>
    );
  }
