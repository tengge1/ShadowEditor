...
class Input extends React.Component {
  ...
  render() {
    ...
    return <input autoFocus={this.props.autoFocus} className={classNames('Input', !show && 'hidden', className)} style={style} type={type} value={val} min={min} max={max} step={step} disabled={disabled} accept={accept} autoComplete={'off'} onBlur={this.handleBlur} onFocus={this.handleFocus} onChange={this.handleChange} onInput={this.handleInput} />;
  }
