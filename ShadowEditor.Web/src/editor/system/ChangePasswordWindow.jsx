            ...
            <Content>
                <Form>
                    <FormControl>
                        ...
                        <Input name={'oldPassword'} type={'password'} value={oldPassword} onChange={this.handleChange} />
                    </FormControl>
                    <FormControl>
                        <Label>{_t('New Password')}</Label>
                        <Input name={'newPassword'} type={'password'} value={newPassword} onChange={this.handleChange} />
                    </FormControl>
                    <FormControl>
