 ...
 * @param {*} options 
 */
function DataSourceManageWindow(options = {}) {
...
DataSourceManageWindow.prototype = Object.create(UI.Control.prototype);
DataSourceManageWindow.prototype.constructor = DataSourceManageWindow;

DataSourceManageWindow.prototype.render = function () {
...
DataSourceManageWindow.prototype.show = function () {
    UI.get('window', this.id).show();
};

DataSourceManageWindow.prototype.hide = function () {
    UI.get('window', this.id).hide();
};

DataSourceManageWindow.prototype.setData = function (data) {
    this.data = data;
    this.updateUI();
};

DataSourceManageWindow.prototype.updateUI = function () {
...
DataSourceManageWindow.prototype.save = function () {
    if (!this.data) {
        return;
    }
...
DataSourceManageWindow.prototype.onEditCategory = function () {
...
export default DataSourceManageWindow;