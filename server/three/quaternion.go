...
func (q Quaternion)Slerp(qa, qb, qm Quaternion, t float64) *Quaternion {
...
func Copy( quaternion Quaternion) {
...
func SetFromEuler(euler Euler, update) {
...
func SetFromAxisAngle( axis, angle ) {
...
func SetFromRotationMatrix( m Matrix4) {
...
func SetFromUnitVectors: function ( vFrom, vTo ) {
...
func Equals: function ( quaternion ) {
...
func FromBufferAttribute( attribute, index ) {
