...
[English](README.md) / 中文 &nbsp;&nbsp; | &nbsp;&nbsp; <a src="https://github.com/tengge1/ShadowEditor/releases/download/v0.5.4/ShadowEditor-win32-x64.zip" title="需要Visual C++ Redistributable for Visual Studio 2015支持">Windows桌面版</a> <a src="https://github.com/tengge1/ShadowEditor/releases/download/v0.5.4/ShadowEditor-linux-x64.zip">Ubuntu桌面版</a>  
